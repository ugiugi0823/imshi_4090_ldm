...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.logvar = torch.full(fill_value=logvar_init, size=(self.num_timesteps,), device="cuda:0")
...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        # if self.logvar.is_cuda:
        #     # print("👑"*40)
        #     print("self.logvar is on GPU")
        # else:
        #     print("👑"*40)
        #     print("self.logvar is on CPU")
        #     print(self.device)
